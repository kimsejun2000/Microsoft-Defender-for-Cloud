...
><br>**Another note:** <br>
[Modules 10](../Modules/Module-10-GCP.md) and [Module 11](../Modules/Module-11-AWS.md) will walk through creating those multicloud connectors. Feel free to skip to those modules and then come back.
...
4. In the new pane, tick the box for the unhealthy resource titled mdclabXXXXXX, and select **Fix** at the bottom of the page. 
...
3. For the workspace, select **mdclab-la-XXXXXXXXXX**
...
### Continue with the next lab: [Module 5 - Improving your Secure Posture](../Modules/Module-05-Improving-your-Secure-Posture.md)
