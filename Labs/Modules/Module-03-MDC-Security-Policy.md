...
#### Prerequisites
To get started with Microsoft Defender for Cloud, you must have a subscription to Microsoft Azure. Please go through [Module 1](../Modules/Module-01-Preparing-the-Environment.md) to get started with a free subscription.
...
4. On the list of **unhealthy resources**, see the current resources: *mdclab-win* and *mdclab-linux*.
5. Select the **mdclab-win** resource and then click on **Create exemption**.

![Create exemption](../Images/asc-management-ports-resource-exemption.gif?raw=true)

6. The create **exemption pane** opens:
    > Keep the default name.<br>
...
### Continue with the next lab: [Module 4 - Regulatory Compliance](../Modules/Module-04-Regulatory-Compliance.md)
