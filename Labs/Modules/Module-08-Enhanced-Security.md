...
3. On the Just-in-time VM access page, select the **Not configure** tab. You should see at least two virtual machines listed: `mdclab-linux` and `mdclab-win`.
4. Select **mdclab-win** and then click on the **Enable JIT on 1 VM** button.
...
7. Review the **Configured** tab, now you should see your VM configured: `mdclab-win`.
8. On the Azure portal sidebar, click on **Virtual Machines**.
9. Click on **mdclab-win**.
...
14. You **are now connected to mdclab-win** server. Close the remote control session/log off.
...
### Continue with the next lab: [Module 9 - Agentless container vulnerability assessment scanning](../Modules/Module-09-Agentless-Container-Vulnerability-Assessment-Scanning.md)
