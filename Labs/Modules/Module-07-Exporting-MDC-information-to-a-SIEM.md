...
7. On the Export configuration, select a resource group: *mdclabs*
8. On the Export target, select the target Log Analytics workspace: *mdclab-la-xxx*
...
11. Click on the **mdclab-la-xxx** workspace.
...
3. On the **Add Azure Sentinel** to a workspace, select **mdclab-la-xxx** workspace. Click **New** on the top bar, or click **Create Azure Sentinel**. 
4. Adding Azure Sentinel to workspace mdclab-la-xxx is now in progress. The process will few minutes. 
...
### Continue with the next lab: [Module 8 – Enhanced Security](../Modules/Module-08-Enhanced-Security.md)
