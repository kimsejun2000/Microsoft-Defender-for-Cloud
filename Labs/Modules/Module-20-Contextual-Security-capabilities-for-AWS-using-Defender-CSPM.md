...
### Continue with the next lab [Module 21 – Contextual Security capabilities for GCP using Defender CSPM](../Modules/Module-21-Contextual-Security-capabilities-for-GCP-using-Defender-CSPM.md)
