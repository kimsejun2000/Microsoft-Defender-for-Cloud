...
Ex:
```
az aks update -n mdclab-aks -g labgroup --attach-acr mdclabacr123
```
...
### Continue with the next lab [Module 19 – Defender for Storage](../Modules/Module-19-Defender-for-Storage.md)
